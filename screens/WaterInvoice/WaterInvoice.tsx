    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        >
          ...
          {detailUser.signedPdfPath && (
            <View style={styles.btnLoginViewBorder}>
              <TouchableOpacity
                style={styles.btnLoginView}
                onPress={() => {
                  Linking.canOpenURL(detailUser.signedPdfPath).then(
                    (supported) => {
                      if (supported) {
                        // Opening the link with some app, if the URL scheme is "http" the web link should be opened
                        // by some browser in the mobile
                        Linking.openURL(detailUser.signedPdfPath);
                      }
                    }
                  );
                }}
              >
                <Text style={styles.btnLoginText}>Xem hóa đơn VAT</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
